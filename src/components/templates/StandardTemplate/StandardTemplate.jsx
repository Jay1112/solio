  ...
  return (
    <>
      <div className="hidden md:flex w-screen h-screen  justify-center items-stretch flex-row overflow-scroll">
        <div className="flex-1 bg-[#0f0f0f] text-white p-4 flex items-center justify-center flex-col">
          ...
          <div className="grid grid-cols-5 mt-4 w-4/5 gap-2">
      ...
      <div className="flex md:hidden">mobile standard</div>
    </>
  );
}
