    ...
    <div className="w-full mx-auto flex items-center justify-center flex-col">
      ...
      <div className="w-full mt-6">
        <NavLink navLinkStyle="block w-full" to="/forgot-password/">
          <span className="inline-block text-secondary hover:text-subprimary">Forgot Password?</span>
        </NavLink>
      </div>
      <div className="w-full mt-2">
        <span className="inline-block text-secondary">Don’t have an account ? </span>
        <NavLink navLinkStyle="inline-block mx-2" to="/forgot-password/">
          <span className="inline-block text-subprimary hover:text-subprimary">create an account</span>
        </NavLink>
      </div>
    </div>
  );
