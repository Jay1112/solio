  ...
  return (
    <div className="w-full mx-auto flex items-center justify-center flex-col">
      ...
      <div className="w-full mt-4">
        <span className="inline-block text-secondary">Already have an account ? do </span>
        <NavLink navLinkStyle="inline-block mx-2" to="/sign-in/">
          <span className="inline-block text-subprimary hover:text-subprimary">sign-in</span>
        </NavLink>
      </div>
    </div>
  );
