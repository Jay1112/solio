  ...
  return (
    <div className="flex p-4 gap-4 font-poppins">
      ...
      <p className="flex-1 flex items-center justify-start min-w-[600px]">
        <a href={itemData.link} target="_blank" className="inline-block bg-subsecondary p-2 flex items-center justify-center rounded-sm mr-2 cursor-pointer">
            <i className="pi pi-external-link"></i>
        </a>
        <span>{itemData.link}</span>
      </p>
      <p className="min-w-[200px] text-center flex items-center justify-start">
        <Button className="primary-button  px-2 py-2 text-md md:text-sm flex items-center justify-center mr-2 rounded-sm">
          <i className="pi pi-pencil"></i>
        </Button>
        <Button className="primary-button  px-2 py-2 text-md md:text-sm flex items-center justify-center mx-2 rounded-sm">
